  //label
  const String sNotify = 'Thông báo';
  const String sClose = "Đóng";

  //error
   const String sErrorConnectTimeOut =
      'Không có phản hồi từ hệ thống, Quý khách vui lòng thử lại sau';
   const String sErrorInternalServer =
      'Lỗi xử lý hệ thống\nXin vui lòng thử lại sau!!!';
   const String sError502 =
   ...
   const String sErrorAccountNotActived =
      'Tài khoản đã bị ngưng hoạt động!!!';
